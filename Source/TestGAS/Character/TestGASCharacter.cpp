...
void ATestGASCharacter::NotifyControllerChanged()
{
...
void ATestGASCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
...
void ATestGASCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ATestGASCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
